...
參考 BMW S1000RR 2019+ TFT 儀表設計：

- **橫向 TFT 佈局**（800×480，符合 Waveshare ESP32-S3-LCD-4.3）
- **上方橫條轉速表**（0-15000 RPM，綠色→紅色漸層）
- **中央超大時速數字**（白色，清晰易讀）
- **深藍背景**（#0a1628，仿 TFT 螢幕）
- **紅色警告**（轉速紅線區 12000+ RPM、高水溫 >95°C）
- **現代運動風格**

### 介面預覽

- **網頁版 Demo：** [demo-v2.html](https://htmlpreview.github.io/?https://github.com/jarvis-ai-assistant17/s1000rr-dashboard/blob/master/demo-v2.html)
- 在瀏覽器可看到完整動態效果
